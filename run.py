...
# Probably something bad happens there
# (single thread, not setting up connection properly)
subprocess.call(["run_ovpn.bat"])

# Starting Spotify application @ C:\Users\%Username%\AppData\Roaming\Spotify
# Change username here
app = Application(backend="uia").start(localappdata + r"\Spotify\Spotify.exe")
